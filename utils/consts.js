...
export const GAME_SHARE = document.querySelector("#compartir")
export let ENGINE_VARS = {board_obj:null,incrementTimer:null,incrementNumber:null , activeCard1 : "",activeCard2 : "",lastID :"",totalSuccess:0};